    ...
    <div class="sidebar-inner affix-top">
        ...
        ?>">
            <div class="site-author motion-element" itemprop="author" itemscope itemtype="http://schema.org/Person">
                <a href="" data-action="imageZoomIn"><img src="<?php echo $this->options->next_gravatar(); ?>" width="100px" height="100px" > </a> 
                <p class="site-author-name" itemprop="name" style="width: 100%;height: 45px;display: block;line-height: 45px;text-align: center;"><?php $this->options->next_name(); ?></p>
                <p class="site-description motion-element" itemprop="description" style="width: 100%;height: 45px;display: block;line-height: 45px;text-align: center;"><?php $this->options->next_tips(); ?></p>
            </div>
